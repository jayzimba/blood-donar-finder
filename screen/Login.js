...
class Login extends Component {
  ...
  LogDataInDB = () => {
    ...
    if (email.length == 0 || password.length == 0) {
      ...
      fetch("https://www.pezabond.com/dalitso/login.php", requestOptions)
        .then((Response) => Response.json())
        .then((Response) => {
          if (Response.success) {
            this.props.navigation.navigate("Seacrh donors");
  ...
  render() {
    return (
      <SafeAreaView style={styles.container}>
        <View>
          <Text style={[styles.bigText, { width: "75%" }]}>
            Blood Donor Finder App
          </Text>
          <Text style={[styles.smallText, { width: "75%" }]}>
